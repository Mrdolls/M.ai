...
class NeuralNetworkManager {
    ...
    /**
     * Save network to JSON format (simplified to only include the "brain")
     * @param {brain.NeuralNetwork} network - The network to save.
     * @param {object} metadata - Optional metadata including type.
     * @returns {object|null} The simplified network JSON or null on error.
     */
